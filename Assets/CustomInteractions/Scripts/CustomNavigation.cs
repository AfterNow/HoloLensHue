...
//                var pos = (Vector3.Scale(new Vector3(0, 0.3f, 0), new Vector3(initialHandToCurrentHandAdjusted.x, initialHandToCurrentHandAdjusted.y, initialHandToCurrentHandAdjusted.z)) + lightUI.transform.position);
//                pos.y = Mathf.Clamp(pos.y, -0.03f, 0.32f);
//                lightSphere.transform.position = pos;
